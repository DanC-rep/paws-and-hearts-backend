...
public class GetVolunteersRequestsByAdminWithPaginationHandler
    : IQueryHandler<PagedList<VolunteerRequestDto>, GetVolunteersRequestsByAdminWithPaginationQuery>
{
    private readonly IVolunteerRequestsReadDbContext _volunteerRequestsReadDbContext;

    public GetVolunteersRequestsByAdminWithPaginationHandler(
    ...
    public async Task<PagedList<VolunteerRequestDto>> Handle(
        GetVolunteersRequestsByAdminWithPaginationQuery query, 
